...
// Example from Objects and dot notation Rep'l challenge //

let favMovie = {
    nameOfMovie: "Gladiator",
    runTime: "150 mins",
    genre: "Action",
    characterInfo: {
      characters: [{
  ...
  console.log(favMovie.characterInfo.characters);
  console.log(favMovie.characterInfo.characters[0].name);
  console.log(favMovie.characterInfo.characters[0].item[1]);
